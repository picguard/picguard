...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	List<AppColor> get colors => [
		Translations$colors$0i0$En.internal(_root),
		Translations$colors$0i1$En.internal(_root),
		Translations$colors$0i2$En.internal(_root),
		Translations$colors$0i3$En.internal(_root),
		Translations$colors$0i4$En.internal(_root),
		Translations$colors$0i5$En.internal(_root),
	];
...
// Path: colors.0
class Translations$colors$0i0$En with AppColor {
	Translations$colors$0i0$En.internal(this._root);
	...
	@override String get label => 'White';
}

// Path: colors.1
class Translations$colors$0i1$En with AppColor {
	Translations$colors$0i1$En.internal(this._root);
	...
	@override String get label => 'Grey';
}

// Path: colors.2
class Translations$colors$0i2$En with AppColor {
	Translations$colors$0i2$En.internal(this._root);
	...
	@override String get label => 'Black';
}

// Path: colors.3
class Translations$colors$0i3$En with AppColor {
	Translations$colors$0i3$En.internal(this._root);
	...
	@override String get label => 'Red';
}

// Path: colors.4
class Translations$colors$0i4$En with AppColor {
	Translations$colors$0i4$En.internal(this._root);
	...
	@override String get blue => '0';
	@override String get label => 'Orange';
}

// Path: colors.5
class Translations$colors$0i5$En with AppColor {
	Translations$colors$0i5$En.internal(this._root);
	...
	@override String get label => 'Blue';
}
