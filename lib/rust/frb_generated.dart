...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 2008576794;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  TaskConstMeta get kCrateApiPicguardGreetConstMeta => const TaskConstMeta(
        debugName: "greet",
        argNames: ["name"],
      );
  ...
  TaskConstMeta get kCrateApiPicguardInitAppConstMeta => const TaskConstMeta(
        debugName: "init_app",
        argNames: [],
      );
