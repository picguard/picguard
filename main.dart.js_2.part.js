...
u.r=A.bly(v)
return v},
blv(d,e){switch(e){case"appName":return new A.aQ1()
...
case"homePage.saveInfo":return new A.aQ2()
...
case"dialogs.permissions.photos.description":return new A.aQ3()
case"dialogs.permissions.storage.title":return"\u5141\u8bb8\u8bbf\u95ee\u60a8\u7684\u5b58\u50a8"
case"dialogs.permissions.storage.description":return new A.aQd()
case"dialogs.licenseDialog.licenseDialogTitle":return"\u9690\u79c1\u6761\u6b3e"
case"dialogs.licenseDialog.licenseDialogContentContent":return new A.aQe()
...
case"dialogs.licenseDialog.iosPermissions.0":return new A.aQf()
case"dialogs.licenseDialog.androidPermissions.0":return new A.aQg()
case"dialogs.licenseDialog.androidPermissions.1":return new A.aQh()
case"dialogs.licenseDialog.androidPermissions.2":return new A.aQi()
case"dialogs.licenseDialog.androidPermissions.3":return new A.aQj()
...
A.a07.prototype={
i(d,e){var x=this.w.v0(e)
return x==null?this.a.v0(e):x},
gvU(){var x=this.x
if(x===$){x!==$&&B.af()
x=this.x=this}return x},
pV(d,e){switch(e.a){case 0:return"PicGuard"
case 1:return"PicGuard Pro"}},
geH(){var x=this,w=x.y
if(w===$){x.gvU()
x.y!==$&&B.af()
w=x.y=new A.aOZ()}return w},
gog(){var x=this,w=x.z
if(w===$){x.gvU()
x.z!==$&&B.af()
w=x.z=new A.aOP()}return w},
gug(){var x=this,w=x.Q
if(w===$){x.gvU()
x.Q!==$&&B.af()
w=x.Q=new A.aP0()}return w},
gdT(d){var x=this,w=x.as
if(w===$){x.gvU()
x.as!==$&&B.af()
w=x.as=new A.aON()}return w},
gfq(){var x,w=this,v=w.at
if(v===$){x=w.gvU()
w.at!==$&&B.af()
v=w.at=new A.aOX(x,x)}return v},
gNh(){var x=y.g
return B.a6(["en","English","it","Italian","zh","\u4e2d\u6587"],x,x)},
gr4(){return this.w}}
A.aOZ.prototype={
gjC(d){return"\u672capp\u4e0d\u4f1a\u4e0a\u4f20\u4efb\u4f55\u56fe\u7247\u5230\u670d\u52a1\u5668, \u6240\u6709\u64cd\u4f5c\u5747\u5728\u672c\u5730\u5b8c\u6210"},
gOh(){return"\u6587\u672c"},
gOi(){return"\u6587\u672c\u4f1a\u4ee5\u6c34\u5370\u6dfb\u52a0\u5230\u56fe\u7247\u4e0a"},
gOj(){return"\u8bf7\u8f93\u5165\u6587\u672c."},
gOg(){return"\u6b64\u8bc1\u4ef6\u4ec5\u7528\u4e8e\u529e\u7406xx\u4e1a\u52a1, \u5176\u4ed6\u7528\u9014\u65e0\u6548"},
gL4(){return"\u989c\u8272"},
gL5(){return"\u8bf7\u9009\u62e9\u989c\u8272."},
gNC(){return"\u4e0d\u900f\u660e\u5ea6"},
gMr(){return"\u5b57\u4f53"},
gMs(){return"\u90e8\u5206\u8bed\u8a00\u4e0d\u652f\u6301\u81ea\u5b9a\u4e49\u5b57\u4f53"},
gMu(){return"\u8bf7\u9009\u62e9\u5b57\u4f53."},
gMt(){return"\u5b57\u4f53\u5927\u5c0f"},
gOf(){return"\u6587\u672c\u95f4\u8ddd"},
gOe(){return"\u6bcf\u884c\u6587\u672c\u4e2d, \u6587\u672c\u4e0e\u6587\u672c\u4e4b\u95f4\u7684\u95f4\u8ddd"},
gOc(){return"\u884c\u95f4\u8ddd"},
gOb(){return"\u6bcf\u884c\u6587\u672c\u4e0e\u6bcf\u884c\u6587\u672c\u4e4b\u95f4\u7684\u95f4\u8ddd"},
gNR(){return"\u9884\u89c8"},
gG4(d){return"\u4fdd\u5b58"},
gG7(){return"\u4fdd\u5b58\u6210\u529f"},
gzA(){return"\u4fdd\u5b58\u5931\u8d25"},
G5(d,e){return"\u5df2\u4fdd\u5b58"+e+"\u5f20, \u4fdd\u5b58\u5931\u8d25"+d+"\u5f20"}}
A.aOP.prototype={
gOY(){return"\u767d\u8272"},
gG2(){return"\u7070\u8272"},
gKL(){return"\u9ed1\u8272"},
...
gGd(){return"\u9009\u62e9\u989c\u8272"},
gGe(){return"\u9009\u62e9\u5b57\u4f53"},
gmc(d){var x,w=this.w
if(w===$){x=this.f
w!==$&&B.af()
w=this.w=new A.aOS(x,x)}return w},
gkV(){var x,w=this.y
if(w===$){x=this.f
w!==$&&B.af()
w=this.y=new A.aOW(x,x)}return w}}
A.aOS.prototype={
guu(){var x=this.e
if(x===$){x!==$&&B.af()
x=this.e=new A.abE()}return x},
grt(d){var x=this.f
if(x===$){x!==$&&B.af()
x=this.f=new A.abG()}return x}}
A.aOW.prototype={
gzR(){return"\u8bbe\u7f6e"},
gN9(d){return"\u8bed\u8a00"},
gr0(){var x=this.d
if(x===$){x!==$&&B.af()
x=this.d=new A.aOV()}return x},
gOm(){return"\u5f00\u542f\u540e, \u5c06\u8ddf\u968f\u7cfb\u7edf\u6253\u5f00\u6216\u5173\u95ed\u6df1\u8272\u6a21\u5f0f"}}
A.abE.prototype={
gnt(d){return"\u5141\u8bb8\u8bbf\u95ee\u60a8\u7684\u76f8\u518c"},
lg(d,e){return"\u8bf7\u524d\u5f80\u60a8\u7684\u624b\u673a\u8bbe\u7f6e\uff0c\u6388\u4e88"+B.m(e)+"\u8bbf\u95ee\u60a8\u76f8\u518c\u7684\u6743\u9650."}}
A.abG.prototype={
gnt(d){return"\u5141\u8bb8\u8bbf\u95ee\u60a8\u7684\u5b58\u50a8"},
lg(d,e){return"\u8bf7\u524d\u5f80\u60a8\u7684\u624b\u673a\u8bbe\u7f6e\uff0c\u6388\u4e88"+B.m(e)+"\u8bbf\u95ee\u60a8\u5b58\u50a8\u7684\u6743\u9650."}}
A.aOV.prototype={
gNn(){return"\u624b\u52a8\u6a21\u5f0f"},
gH_(){return"\u8ddf\u968f\u7cfb\u7edf"},
gDc(){return"\u6df1\u8272\u6a21\u5f0f"},
...
$S:125}
A.aQ2.prototype={
$2$failedNum$succeedNum(d,e){return"\u5df2\u4fdd\u5b58"+B.m(e)+"\u5f20, \u4fdd\u5b58\u5931\u8d25"+B.m(d)+"\u5f20"},
$C:"$2$failedNum$succeedNum",
$R:0,
$D(){return{failedNum:C.W,succeedNum:C.W}},
$S:129}
A.aQ3.prototype={
$1$appName(d){return"\u8bf7\u524d\u5f80\u60a8\u7684\u624b\u673a\u8bbe\u7f6e\uff0c\u6388\u4e88"+B.m(d)+"\u8bbf\u95ee\u60a8\u76f8\u518c\u7684\u6743\u9650."},
$C:"$1$appName",
$R:0,
$D(){return{appName:C.W}},
$S:9}
A.aQd.prototype={
$1$appName(d){return"\u8bf7\u524d\u5f80\u60a8\u7684\u624b\u673a\u8bbe\u7f6e\uff0c\u6388\u4e88"+B.m(d)+"\u8bbf\u95ee\u60a8\u5b58\u50a8\u7684\u6743\u9650."},
$C:"$1$appName",
$R:0,
$D(){return{appName:C.W}},
$S:9}
A.aQe.prototype={
$1$appName(d){return B.m(d)+"\u975e\u5e38\u91cd\u89c6\u4f60\u7684\u9690\u79c1\u4fdd\u62a4\u548c\u4e2a\u4eba\u4fe1\u606f\u4fdd\u62a4."},
$C:"$1$appName",
$R:0,
$D(){return{appName:C.W}},
$S:9}
A.aQf.prototype={
$1$appName(d){return"\u4e3a\u4e86\u7ed9\u60a8\u7684\u56fe\u50cf\u6dfb\u52a0\u6c34\u5370, "+B.m(d)+"\u9700\u8981\u8bbf\u95ee\u60a8\u7684\u7167\u7247. (NSPhotoLibraryUsageDescription)"},
$C:"$1$appName",
$R:0,
$D(){return{appName:C.W}},
$S:9}
A.aQg.prototype={
$1$appName(d){return"\u4e3a\u4e86\u4f7f\u7528 Sentry \u670d\u52a1, "+B.m(d)+"\u9700\u8981\u8bbf\u95ee\u60a8\u7684\u4e92\u8054\u7f51. (android.permission.INTERNET)"},
$C:"$1$appName",
$R:0,
$D(){return{appName:C.W}},
$S:9}
A.aQh.prototype={
$1$appName(d){return"\u4e3a\u4e86\u7ed9\u60a8\u7684\u56fe\u50cf\u6dfb\u52a0\u6c34\u5370, "+B.m(d)+"\u9700\u8981\u8bbf\u95ee\u60a8\u7684\u5b58\u50a8. (android.permission.READ_EXTERNAL_STORAGE)"},
$C:"$1$appName",
$R:0,
$D(){return{appName:C.W}},
$S:9}
A.aQi.prototype={
$1$appName(d){return"\u4e3a\u4e86\u8ba9\u60a8\u4fdd\u5b58\u56fe\u7247, "+B.m(d)+"\u9700\u8981\u8bbf\u95ee\u60a8\u7684\u5b58\u50a8. (android.permission.WRITE_EXTERNAL_STORAGE)"},
$C:"$1$appName",
$R:0,
$D(){return{appName:C.W}},
$S:9}
A.aQj.prototype={
$1$appName(d){return"\u4e3a\u4e86\u7ed9\u60a8\u7684\u56fe\u50cf\u6dfb\u52a0\u6c34\u5370, "+B.m(d)+"\u9700\u8981\u8bbf\u95ee\u60a8\u7684\u7167\u7247. (android.permission.READ_MEDIA_IMAGES)"},
$C:"$1$appName",
$R:0,
$D(){return{appName:C.W}},
$S:9};(function installTearOffs(){var x=a.installInstanceTearOff
