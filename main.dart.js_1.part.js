...
t.r=A.blz(u)
return u},
blw(d,e){switch(e){case"appName":return new A.aQk()
...
case"homePage.textGapDescription":return y.a
...
case"homePage.saveInfo":return new A.aQ4()
...
case"dialogs.permissions.photos.description":return new A.aQ5()
case"dialogs.permissions.storage.title":return"Consenti l'accesso al tuo archivio"
case"dialogs.permissions.storage.description":return new A.aQ6()
case"dialogs.licenseDialog.licenseDialogTitle":return"Termini e Condizioni"
case"dialogs.licenseDialog.licenseDialogContentContent":return new A.aQ7()
case"dialogs.licenseDialog.licenseDialogContentTip":return"Di seguito \xe8 riportato l'elenco delle autorizzazioni richieste da questa APP:"
...
case"dialogs.licenseDialog.iosPermissions.0":return new A.aQ8()
case"dialogs.licenseDialog.androidPermissions.0":return new A.aQ9()
case"dialogs.licenseDialog.androidPermissions.1":return new A.aQa()
case"dialogs.licenseDialog.androidPermissions.2":return new A.aQb()
case"dialogs.licenseDialog.androidPermissions.3":return new A.aQc()
...
case"dialogs.settingsDialog.themes.system":return"Modalit\xe0 automatica"
case"dialogs.settingsDialog.themes.dark":return"Modalit\xe0 scura"
case"dialogs.settingsDialog.themes.light":return"Modalit\xe0 chiara"
case"dialogs.settingsDialog.themesDescription":return y.c
case"locales.en":return"English"
case"locales.it":return"Italian"
case"locales.zh":return"\u4e2d\u6587"
default:return null}},
blz(d){return new A.aQn(d)},
...
A.a06.prototype={
i(d,e){var w=this.w.v0(e)
return w==null?this.a.v0(e):w},
gvT(){var w=this.x
if(w===$){w!==$&&B.af()
w=this.x=this}return w},
pV(d,e){switch(e.a){case 0:return"PicGuard"
case 1:return"PicGuard Pro"}},
geH(){var w=this,v=w.y
if(v===$){w.gvT()
w.y!==$&&B.af()
v=w.y=new A.aOY()}return v},
gog(){var w=this,v=w.z
if(v===$){w.gvT()
w.z!==$&&B.af()
v=w.z=new A.aOO()}return v},
gug(){var w=this,v=w.Q
if(v===$){w.gvT()
w.Q!==$&&B.af()
v=w.Q=new A.aP_()}return v},
gdT(d){var w=this,v=w.as
if(v===$){w.gvT()
w.as!==$&&B.af()
v=w.as=new A.aOM()}return v},
gfq(){var w,v=this,u=v.at
if(u===$){w=v.gvT()
v.at!==$&&B.af()
u=v.at=new A.aOQ(w,w)}return u},
gNh(){var w=x.g
...
gOh(){return"Testo"},
gOi(){return y._},
gOj(){return"Inserisci il testo."},
gOg(){return y.N},
gL4(){return"Colore"},
gL5(){return"Seleziona un colore."},
gNC(){return"Opacit\xe0"},
gMr(){return"Font"},
gMs(){return y.s},
gMu(){return"Seleziona un font."},
gMt(){return"Dimensione del font"},
gOf(){return"Spaziatura del testo"},
gOe(){return y.a},
gOc(){return"Interlinea"},
gOb(){return"La spaziatura tra ogni riga di testo"},
gNR(){return"Anteprima"},
gG4(d){return"Salva"},
gG7(){return"Salvataggio riuscito"},
gzA(){return"Impossibile salvare l'immagine(i)"},
G5(d,e){return"Sono state salvate "+e+y.I+d+" l'immagine(i)."}}
A.aOO.prototype={
gOY(){return"Bianco"},
gG2(){return"Grigio"},
gKL(){return"Nero"},
...
gMU(){return"Aiuto"},
gGZ(){return"Supporto"},
gON(){return"Accordo utente"},
gNS(){return"Politica sulla riservatezza"}}
A.aOM.prototype={
gE6(){return"Ignora"},
gFE(){return"Accendi"}}
A.aOQ.prototype={
gGd(){return"Seleziona un colore"},
gGe(){return"Seleziona un carattere"},
gmc(d){var w,v=this.w
if(v===$){w=this.f
v!==$&&B.af()
v=this.w=new A.aOR(w,w)}return v},
gkV(){var w,v=this.y
if(v===$){w=this.f
v!==$&&B.af()
v=this.y=new A.aOT(w,w)}return v}}
A.aOR.prototype={
guu(){var w=this.e
if(w===$){w!==$&&B.af()
w=this.e=new A.abD()}return w},
grt(d){var w=this.f
if(w===$){w!==$&&B.af()
w=this.f=new A.abF()}return w}}
A.aOT.prototype={
gzR(){return"Impostazioni"},
gN9(d){return"Lingue"},
gr0(){var w=this.d
if(w===$){w!==$&&B.af()
w=this.d=new A.aOU()}return w},
gOm(){return y.c}}
A.abD.prototype={
gnt(d){return"Consenti l'accesso al tuo album"},
lg(d,e){return y.e+B.m(e)+y.S}}
A.abF.prototype={
gnt(d){return"Consenti l'accesso al tuo archivio"},
lg(d,e){return y.g+B.m(e)+y.j}}
A.aOU.prototype={
gNn(){return"Modalit\xe0 manuale"},
gH_(){return"Modalit\xe0 automatica"},
gDc(){return"Modalit\xe0 scura"},
gNe(){return"Modalit\xe0 chiara"}}
var z=a.updateTypes(["j({appName!G})"])
A.aQn.prototype={
$1(d){return A.blw(this.a,d)},
$S:74}
A.aQk.prototype={
...
$S:125}
A.aQ4.prototype={
$2$failedNum$succeedNum(d,e){return"Sono state salvate "+B.m(e)+y.I+B.m(d)+" l'immagine(i)."},
$C:"$2$failedNum$succeedNum",
$R:0,
$D(){return{failedNum:C.W,succeedNum:C.W}},
$S:129}
A.aQ5.prototype={
$1$appName(d){return y.e+B.m(d)+y.S},
$C:"$1$appName",
$R:0,
$D(){return{appName:C.W}},
$S:9}
A.aQ6.prototype={
$1$appName(d){return y.g+B.m(d)+y.j},
$C:"$1$appName",
$R:0,
$D(){return{appName:C.W}},
$S:9}
A.aQ7.prototype={
$1$appName(d){return"La protezione della privacy e delle informazioni personali degli utenti \xe8 un principio fondamentale di "+B.m(d)+"."},
$C:"$1$appName",
$R:0,
$D(){return{appName:C.W}},
$S:9}
A.aQ8.prototype={
$1$appName(d){return y.C+B.m(d)+" deve accedere alle tue foto. (NSPhotoLibraryUsageDescription)"},
$C:"$1$appName",
$R:0,
$D(){return{appName:C.W}},
$S:9}
A.aQ9.prototype={
$1$appName(d){return"Per poter utilizzare il servizio Sentry, "+B.m(d)+" deve avere accesso a Internet. (android.permission.INTERNET)"},
$C:"$1$appName",
$R:0,
$D(){return{appName:C.W}},
$S:9}
A.aQa.prototype={
$1$appName(d){return"Per filigranare le tue immagini, "+B.m(d)+" deve accedere al tuo spazio di archiviazione. (android.permission.READ_EXTERNAL_STORAGE)"},
$C:"$1$appName",
$R:0,
$D(){return{appName:C.W}},
$S:9}
A.aQb.prototype={
$1$appName(d){return"Per poter salvare le immagini, "+B.m(d)+" deve accedere al tuo spazio di archiviazione. (android.permission.WRITE_EXTERNAL_STORAGE)"},
$C:"$1$appName",
$R:0,
$D(){return{appName:C.W}},
$S:9}
A.aQc.prototype={
$1$appName(d){return y.C+B.m(d)+" deve accedere alle tue foto. (android.permission.READ_MEDIA_IMAGES)"},
$C:"$1$appName",
$R:0,
$D(){return{appName:C.W}},
$S:9};(function installTearOffs(){var w=a.installInstanceTearOff
