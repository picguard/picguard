...
if [ ! -f "$FLUTTER_DIR/flutter-3.24.3-aarch64.tar.xz" ]; then
   echo "🟩 Downloading Flutter"
   wget https://github.com/containerbase/flutter-prebuild/releases/download/3.24.3/flutter-3.24.3-aarch64.tar.xz -P "$FLUTTER_DIR"
fi
...
echo "🟩 Unzipping"
mkdir "$FLUTTER_DIR/flutter" && tar -xf "$FLUTTER_DIR/flutter-3.24.3-aarch64.tar.xz" -C "$FLUTTER_DIR/flutter" --strip-components 1
